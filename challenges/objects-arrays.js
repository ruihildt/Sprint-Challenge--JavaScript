...
console.log(`The ${tyrannosaurus.name} was weighting ${tyrannosaurus.weight}.`);

// What was the diet of a velociraptor?
console.log(`The ${velociraptor.name} was ${velociraptor.diet}.`);

// How long was a stegosaurus?
console.log(`The ${stegosaurus.name} was ${stegosaurus.length} long.`);

// What time period did tyrannosaurus live in?
console.log(`The ${tyrannosaurus.name} was living in the ${tyrannosaurus.period}.`);
...
for (let i = 0; i < graduates.length; i++) {
  let info = `${graduates[i].first_name} ${graduates[i].email}`;
...
for (let i = 0; i < universities.length; i++) {
  universities[i].includes('Uni') == 'Uni';
...
zooAnimals.forEach(animal => {
  let names = `Name: ${animal.animal_name}, Scientific: ${animal.scientific_name}`;
